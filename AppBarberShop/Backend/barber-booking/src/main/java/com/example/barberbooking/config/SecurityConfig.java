...
@Configuration
@EnableWebSecurity
// Abilita la sicurezza a livello di metodo, necessaria per usare annotazioni come @PreAuthorize.
              ...
              .cors(Customizer.withDefaults())
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/barbers/**")
                                .hasRole("ADMIN")

                                .requestMatchers(HttpMethod.PUT, "/api/barbers/**")
                                .hasRole("ADMIN")

                                .requestMatchers(HttpMethod.DELETE, "/api/barbers/**")
                                .hasRole("ADMIN")
